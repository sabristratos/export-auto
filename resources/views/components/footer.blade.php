<footer class="bg-neutral-900 text-neutral-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <!-- Contact Information -->
            <div class="lg:col-span-1">
                <h3 class="text-white font-semibold text-sm uppercase tracking-wide mb-4">Contact Info</h3>
                <div class="space-y-3">
            ...
            <!-- Social Media -->
            <div class="lg:col-span-1">
                <h3 class="text-white font-semibold text-sm uppercase tracking-wide mb-4">Follow Us</h3>
        ...
        <div class="border-t border-neutral-800 pt-8 mb-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <!-- Statistics -->
                <div>
                    <h3 class="text-white font-semibold text-sm uppercase tracking-wide mb-6">Our Numbers</h3>
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        <div class="text-left">
                            <div class="text-2xl font-bold text-white mb-1">{{ \App\Models\Car::count() }}+</div>
                            <div class="text-neutral-300 text-xs">Cars Available</div>
                        </div>
                        <div class="text-left">
                            <div class="text-2xl font-bold text-white mb-1">{{ \App\Models\Review::count() }}+</div>
                            <div class="text-neutral-300 text-xs">Happy Clients</div>
                        </div>
                        <div class="text-left">
                            <div class="text-2xl font-bold text-white mb-1">5+</div>
                            <div class="text-neutral-300 text-xs">Years Experience</div>
                        </div>
                        <div class="text-left">
                            <div class="text-2xl font-bold text-white mb-1">25+</div>
                            <div class="text-neutral-300 text-xs">Countries Served</div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Car Makes -->
                <div>
                    <h3 class="text-white font-semibold text-sm uppercase tracking-wide mb-6">Premium Brands</h3>
                    <div class="grid grid-cols-3 sm:grid-cols-4 gap-4">
                        @php
                            $makes = ['Mercedes-Benz', 'BMW', 'Audi', 'Porsche', 'Volkswagen', 'Ferrari', 'Lamborghini', 'Bentley'];
                        @endphp
                        @foreach($makes as $make)
                            <div class="bg-neutral-800 hover:bg-neutral-700 rounded-lg p-3 text-center transition-colors duration-200">
                                <div class="text-neutral-200 text-xs font-medium">{{ $make }}</div>
                            </div>
                        @endforeach
                    </div>
                </div>
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center">
                ...
                <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-6 mt-4 sm:mt-0 items-center">
                    <div class="flex space-x-6">
                        <a href="{{ route('legal.show', 'privacy-policy') }}" class="text-neutral-400 hover:text-white text-sm transition-colors duration-200">Privacy Policy</a>
                        <a href="{{ route('legal.show', 'terms-of-service') }}" class="text-neutral-400 hover:text-white text-sm transition-colors duration-200">Terms of Service</a>
                        <a href="{{ route('legal.show', 'cookie-policy') }}" class="text-neutral-400 hover:text-white text-sm transition-colors duration-200">Cookie Policy</a>
                    </div>

                    <div class="text-neutral-400 text-xs">
                        Rosa Media Powered by Stratos
                    </div>
                </div>
            </div>
        </div>
